...
* within that range, inclusive of the endpoints.
...
Complete the squares function in the editor below. It should return an integer representing the
*  number of square integers in the inclusive range from  to .
...
Each of the next  lines contains two space-separated integers denoting  and , the starting and
* ending integers in the ranges.
